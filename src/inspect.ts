...
/**
 * Derive the public interaction surface from compiled standard Adaptive Card JSON.
 * This is documentation and compatibility metadata, never a second authored protocol.
 */
